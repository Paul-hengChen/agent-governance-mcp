...
test("AC2: lean always-on bundle is below the raw baseline and within target (<= 2000 ~tok)", () => {
  ...
  assert.ok(lean <= 2000, `lean always-on (${lean} ~tok) must meet the <= 2000 target`);
});
