...
> **Status**: production-used, v3.44.0. Suite **779/779**. Stdio mode is solo/single-machine; HTTP+SQLite mode is for multi-machine teams.
...
claude mcp add -s user agent-governance-mcp -- npx -y github:Paul-hengChen/agent-governance-mcp#v3.44.0
...
npx -y github:Paul-hengChen/agent-governance-mcp#v3.44.0 agc init
