...
> **Status**: production-used, v3.73.1. Suite **1251/1251**. Stdio mode is solo/single-machine; HTTP+SQLite mode is for multi-machine teams.
...
claude mcp add -s user agent-governance-mcp -- npx -y github:Paul-hengChen/agent-governance-mcp#v3.73.1
...
npx -y github:Paul-hengChen/agent-governance-mcp#v3.73.1 agc init
