...
> **Status**: production-used, v3.45.0. Suite **824/824**. Stdio mode is solo/single-machine; HTTP+SQLite mode is for multi-machine teams.
...
claude mcp add -s user agent-governance-mcp -- npx -y github:Paul-hengChen/agent-governance-mcp#v3.45.0
...
npx -y github:Paul-hengChen/agent-governance-mcp#v3.45.0 agc init
