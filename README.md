...
> **Status**: production-used, v3.57.0. Suite **959/959**. Stdio mode is solo/single-machine; HTTP+SQLite mode is for multi-machine teams.
...
claude mcp add -s user agent-governance-mcp -- npx -y github:Paul-hengChen/agent-governance-mcp#v3.57.0
...
npx -y github:Paul-hengChen/agent-governance-mcp#v3.57.0 agc init
