...
> **Status**: production-used, v3.68.1. Suite **1166/1166**. Stdio mode is solo/single-machine; HTTP+SQLite mode is for multi-machine teams.
...
claude mcp add -s user agent-governance-mcp -- npx -y github:Paul-hengChen/agent-governance-mcp#v3.68.1
...
npx -y github:Paul-hengChen/agent-governance-mcp#v3.68.1 agc init
