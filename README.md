...
> **Status**: production-used, v3.94.0. Suite **1633/1633**. Stdio mode is solo/single-machine; HTTP+SQLite mode is for multi-machine teams.
...
npx -y -p github:Paul-hengChen/agent-governance-mcp#v3.94.0 agc init
