...
claude mcp add -s user agent-governance-mcp -- npx -y github:Paul-hengChen/agent-governance-mcp#v3.103.1
...
npx -y -p github:Paul-hengChen/agent-governance-mcp#v3.103.1 agc init
...
```json
{
  "hooks": {
    "SessionStart": [{
      ...
      "hooks": [{
        "type": "command",
        "command": "npx -y -p github:Paul-hengChen/agent-governance-mcp#v3.103.1 agent-governance-context",
        "timeout": 60
      }]
    }]
  }
