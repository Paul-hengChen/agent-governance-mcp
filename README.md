...
> **Status**: production-used, v3.71.0. Suite **1186/1186**. Stdio mode is solo/single-machine; HTTP+SQLite mode is for multi-machine teams.
...
claude mcp add -s user agent-governance-mcp -- npx -y github:Paul-hengChen/agent-governance-mcp#v3.71.0
...
npx -y github:Paul-hengChen/agent-governance-mcp#v3.71.0 agc init
