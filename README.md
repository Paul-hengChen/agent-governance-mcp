...
claude mcp add -s user agent-governance-mcp -- npx -y github:Paul-hengChen/agent-governance-mcp#v3.77.0
...
npx -y github:Paul-hengChen/agent-governance-mcp#v3.77.0 agc init
