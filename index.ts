    ...
    prompts: [
      {
        name: "sr-engineer",
        description:
          "Activate sr-engineer mode. Auto-loads the workspace constitution, skill definition, and current project state. Use this at the start of any coding session.",
        arguments: [
          {
            name: "workspace_path",
    ...
    tools: [
      {
        name: "sdd_get_state",
        description:
          "Read the current project handoff state (.current/handoff.md) as structured JSON. " +
      ...
      },
      {
        ...
        description:
          "Atomically update the project handoff state. Format is enforced server-side — " +
      ...
      },
      {
        ...
        description:
          "Get the next incomplete task from tasks.md. Returns task ID, file path, phase, " +
      ...
      },
      {
        ...
        description:
          "Mark a specific task as completed [x] in tasks.md. Optionally add a note (e.g., 'via vibe coding'). " +
      ...
      },
      {
        ...
        description:
          "Revert a completed task back to incomplete: [x] → [ ] (reverted: reason). " +
      ...
      },
      {
        ...
        description:
          "Compare handoff.md state against tasks.md checkboxes to detect inconsistencies. " +
