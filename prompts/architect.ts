// Coded by @architect
// MCP Prompt: architect — auto-injects constitution + skill + project state
...
export function buildArchitectPrompt(workspacePath: string): {
  description: string;
  messages: Array<{ role: "user"; content: { type: "text"; text: string } }>;
} {
  const constitution = loadContent("constitution.md", workspacePath);
  const skill = loadContent("skill-architect.md", workspacePath);
