...
| E15 | `test/handoff-write-arg-guard.test.mjs` AC-1 concurrency flake: passes consistently in isolation; flakes ~1-in-3 on full-suite runs (observed independently by code-reviewer and qa-engineer 2026-07-13) — investigate and fix concurrency guard or test isolation | P3 | — | ~2 (test isolation / race condition fix + test reproducer) | — |
