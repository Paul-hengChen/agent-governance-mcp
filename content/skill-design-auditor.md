...
2b. **Source-Credibility Classification (v3.38.0)** — fetch-based modes only (`figma`/`sketch`/`xd`/`penpot`). BEFORE extracting any values, classify each target node into one of:
